...
const Home = ({ onAddToCart }) => {
  return (
    <main className="relative min-h-screen">
      ...
      {/* Static Product Card */}
      <div className="relative z-10 flex items-center justify-center min-h-screen pt-8 md:pt-4 pb-8 px-2">
      ...
      <footer className="relative z-10 flex items-center justify-between px-4 md:px-8 py-6 md:py-8 bg-transparent">
        ...
        <a 
          ...
          className="flex items-center gap-2 md:gap-3 text-white hover:text-wc-purple transition-colors font-mono text-sm md:text-lg focus-visible:outline-dashed focus-visible:outline-2 focus-visible:outline-wc-purple rounded-md px-2 py-1"
        >
